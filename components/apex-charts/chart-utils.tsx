...
/** Adds 10% padding to max Y value */
...
/** Adds symmetric padding to both min and max based on extremes */
export const calculateMinMaxY = (data: number[]) => {
...
const getOrDash = (val: number | string | null | undefined): string =>
  val !== null && val !== undefined ? String(val) : "–";

/** Tooltip HTML for ApexCharts based on full dataset + index */
...
/** Shared area/bar chart fill config with vertical pastel gradient */
...
/** Returns smooth curved line stroke style */
